...
var arr=["gand"];
router.post('/',(req,res)=>{
  river.find({river_name:req.body.river_name,state:req.body.state}).then((doc)=>{
    if(doc.length===0)
    {
...
router.post('/update',(req,res)=>{
  var current_date=new Date();
  river.findOne({river_name:req.body.river_name,userID:req.body.userID}).then((doc)=>{
    ...
    doc.type_of_uses.push(req.body.tou);
